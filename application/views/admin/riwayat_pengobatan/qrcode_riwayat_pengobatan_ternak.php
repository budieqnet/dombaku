    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mt-4">
                    <div class="col-lg-12 mx-auto">
                        <form method="post" action="<?=base_url()?>index.php/admin_penyakitkambing/qrcode_update_kondisi/<?=$riwayat_penyakit_ternak['id_penyakit']?>/<?=$riwayat_penyakit_ternak['kode_kambing']?>" enctype="multipart/form-data">
                            <div class="card card-outline card-success">
                                <div class="card-header">
                                    <h3 class="card-title"><strong>Tindakan Medis</strong></h3>
                                    <a class="btn btn-warning btn-sm float-right" href="<?=base_url()?>index.php/admin_penyakitkambing/qrcode_penyakit/<?=$riwayat_penyakit_ternak['kode_kambing']?>"><i class="fa fa-backward"></i></a>
                                </div>
                                <div class="card-body">
                                    ...
                                    <?php $no = 1; foreach ($riwayat_pengobatan_ternak as $row): ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                ...
                                                <a class="btn btn-danger btn-sm" href="<?=base_url()?>index.php/admin_pengobatankambing/qrcode_hapus/<?=$row['id_pengobatan']?>/<?=$row['id_riwayat_sakit']?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                    <?php $no++; endforeach;?>
                                    </tbody>
        ...
        <div class="modal fade" id="tambah">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_pengobatankambing/qrcode_tambah/<?=$riwayat_penyakit_ternak['id_penyakit']?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="update<?=$data['id_pengobatan']?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_pengobatankambing/qrcode_update/<?=$data['id_riwayat_sakit']?>" enctype="multipart/form-data">
                        <div class="modal-header">
