    <div class="content-wrapper">
                    ...
                    <div class="col-lg-12 mx-auto">
                        ...
                        <div class="card card-outline card-success">
                            <div class="card-header">
                                <h3 class="card-title"><strong>Riwayat Penyakit</strong></h3>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                ...
                                                <!-- <a class="btn btn-danger btn-sm" href="<?=base_url()?>index.php/admin_penyakitkambing/hapus_data/<?=$row['id_penyakit']?>/<?=$row['kode_kambing']?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a> -->
                                            </td>
                                            <td style="text-align:center">
                                                <a class="btn btn-info btn-sm" href="<?=base_url()?>index.php/pegawai_pengobatankambing/riwayat_pengobatan/<?=$row['id_penyakit']?>"><i class="fa fa-medkit"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
                                        $no++;
        ...
        <div class="modal fade" id="tambah">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/pegawai_penyakitkambing/proses_tambah" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="update<?=$data['id_penyakit']?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/pegawai_penyakitkambing/proses_update" enctype="multipart/form-data">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="kode_kambing">Kode Ternak</label>
                                <select class="form-control select2bs4" name="kode_kambing" disabled>
                                    <option value="">--- Pilih Kode ---</option>
                                    <?php foreach ($kambing as $row): ?>
                                    <option value="<?=$row['kode']?>" <?=($row['kode']==$data['kode_kambing'])?"selected":""?>><?=$row['kode']?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
