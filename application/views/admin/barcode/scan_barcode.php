<div class="content-wrapper">
    ...
    $(document).ready(function() 
    {
        ...
        $('#startScan').click(function() {
            ...
            $.ajax({
                url: '<?=base_url()?>index.php/barcode/view_barcode',
                type: 'POST',
                ...
                success: function(response) {
                    ...
                    if (result.status === 'success') {
                        ...
                        tampil_data = "<div class='row'>" +
                                      ...
                                      "<a class='btn btn-info btn-xs mr-1' href='<?=base_url()?>index.php/admin_pertumbuhankambing/qrcode_pertumbuhan/" + result.data.kode + "' >Pertumbuhan</a>" + 
                                      "<a class='btn btn-warning btn-xs mr-1' href='<?=base_url()?>index.php/admin_vaksinkambing/qrcode_vaksin/" + result.data.kode +"'>Vaksin</a>" + 
                                      "<a class='btn btn-danger btn-xs' href='<?=base_url()?>index.php/admin_penyakitkambing/qrcode_penyakit/" + result.data.kode + "'>Penyakit</a>" +
                                      "</div></div>";
