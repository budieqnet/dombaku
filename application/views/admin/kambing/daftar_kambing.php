<div class="content-wrapper">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                ...
                                                <a class="btn btn-danger btn-sm" href="<?=base_url()?>index.php/admin_idkambing/hapus_kambing/<?=$row['id']?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
                                        $no++;
        ...
        <div class="modal fade" id="tambah">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_idkambing/proses_tambah" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="update<?=$data['id']?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_idkambing/proses_update" enctype="multipart/form-data">
                        <div class="modal-header">
