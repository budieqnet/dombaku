            ...
            <div class="container-fluid">
                <div class="row mt-4">
                    <div class="col-md-6 mx-auto">
                        <form method="post" action="<?=base_url()?>index.php/admin_user/proses_update_profil" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" id="group" name="group" required>
                                                ...
                                                <option value=<?=$row['id']?> <?=($row['id']==$profile_user['group_id'])?"selected":""?>><?=$row['nama']?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
