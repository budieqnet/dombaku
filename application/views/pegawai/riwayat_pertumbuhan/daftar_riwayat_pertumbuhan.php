<div class="content-wrapper">
                    ...
                    <div class="col-lg-12 mx-auto">
                        ...
                        <div class="card card-outline card-success">
                            <div class="card-header">
                                <h3 class="card-title"><strong>Riwayat Pertumbuhan</strong></h3>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                ...
                                                <!-- <a class="btn btn-danger btn-sm" href="<?=base_url()?>index.php/admin_pertumbuhankambing/hapus_data/<?=$row['id']?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a> -->
                                            </td>
                                        </tr>
                                    <?php 
                                        $no++;
        ...
        <div class="modal fade" id="tambah">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/pegawai_pertumbuhankambing/proses_tambah" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="update<?=$data['id']?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/pegawai_pertumbuhankambing/proses_update" enctype="multipart/form-data">
                        <div class="modal-header">
