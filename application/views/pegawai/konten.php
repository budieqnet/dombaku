                                    ...
                                    <tbody>
                                        <?php foreach ($slow_growth as $s): ?>
                                            <tr class="table-warning">
                                                <td><a href="<?=base_url()?>index.php/pegawai_pertumbuhankambing/qrcode_pertumbuhan/<?=$s['kode']?>"><?=$s['kode']?></a></td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class='btn btn-info btn-xs' href='<?=base_url()?>index.php/pegawai_pertumbuhankambing/qrcode_pertumbuhan/<?=$row['kode']?>' ><i class="fas fa-search"></i></a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
