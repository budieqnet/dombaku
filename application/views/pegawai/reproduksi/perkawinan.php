<div class="content-wrapper">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            ...
                                            <a class="btn btn-danger btn-sm" href="<?=base_url()?>index.php/pegawai_reproduksi/proses_hapus_perkawinan/<?=$row['id']?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php 
                                    $no++;
    ...
    <div class="modal fade" id="tambah">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="<?=base_url()?>index.php/pegawai_reproduksi/proses_tambah_perkawinan">
    ...
    <div class="modal fade" id="update<?=$row['id']?>">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="<?=base_url()?>index.php/pegawai_reproduksi/proses_update_perkawinan">
                    <div class="modal-header">
