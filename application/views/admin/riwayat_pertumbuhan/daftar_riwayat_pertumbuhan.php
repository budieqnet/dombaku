<div class="content-wrapper">
        ...
        <div class="modal fade" id="tambah">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_pertumbuhankambing/proses_tambah" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="update<?=$data['id']?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_pertumbuhankambing/proses_update" enctype="multipart/form-data">
                        <div class="modal-header">
