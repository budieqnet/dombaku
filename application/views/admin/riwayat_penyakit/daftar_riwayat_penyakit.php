    <div class="content-wrapper">
                                ...
                                <table id="table" class="table table-bordered table-striped">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                <a class="btn btn-info btn-sm" href="<?=base_url()?>index.php/admin_pengobatankambing/riwayat_pengobatan/<?=$row['id_penyakit']?>"><i class="fa fa-medkit"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
                                        $no++;
        ...
        <div class="modal fade" id="tambah">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_penyakitkambing/proses_tambah" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="update<?=$data['id_penyakit']?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_penyakitkambing/proses_update" enctype="multipart/form-data">
                        <div class="modal-header">
