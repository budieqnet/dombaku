                            ...
                            <table id="table" class="table table-bordered table-striped">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center">
                                            <a class="btn btn-danger btn-sm" href="<?=base_url()?>index.php/pegawai_reproduksi/proses_hapus_birahi/<?=$row['id']?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php 
                                    $no++;
    ...
    <div class="modal fade" id="tambah">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="<?=base_url()?>index.php/pegawai_reproduksi/proses_tambah_birahi">
