<div class="content-wrapper">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center">
                                                ...
                                                <a class="btn btn-danger btn-sm" href="<?=base_url()?>index.php/admin_pertumbuhankambing/qrcode_hapus/<?=$row['id']?>/<?=$kode_ternak?>" onclick="return confirm('Yakin akan menghapus data?');"><i class="far fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                    <?php 
                                        $no++;
        ...
        <div class="modal fade" id="tambah">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_pertumbuhankambing/qrcode_tambah/<?=$kode_ternak?>" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="update<?=$data['id']?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?=base_url()?>index.php/admin_pertumbuhankambing/qrcode_update/<?=$kode_ternak?>" enctype="multipart/form-data">
                        <div class="modal-header">
